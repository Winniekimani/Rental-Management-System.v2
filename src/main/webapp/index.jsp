...
<div class="row">
    ...
    <jsp:setProperty name="loginForm" property="emailPlaceHolder" value="Enter email"/>
    <div class="col-md-12">
        ...
        <div class="panel panel-default login">
            ...
            <div class="panel-body">
                <form class="form-horizontal center-block" role="form" action="./login" method="post">
                    ...
                    <div class="input-group input-group-lg">
                        ...
                        <input type="email" maxlength="200" class="form-control" name="email" placeholder="${loginForm.emailPlaceHolder}" required aria-describedby="sizing-addon1">
                    </div>
                    <br/>
                    <div class="input-group input-group-lg">
                        <span class="input-group-addon" id="sizing-addon1"><span class="glyphicon glyphicon-lock" aria-hidden="true"></span></span>
                        <input type="password" name="password" maxlength="200" class="form-control" placeholder="${loginForm.passwordPlaceHolder}" required aria-describedby="sizing-addon1">
                    </div>
                    <br/>
            ...
            <a href="./register.jsp" style="text-align:Center;font-weight:bold;font-size:120%;padding: 0 2%">Register As Tenant</a>
        </div>
    </div>
</div>
